...
export class EventData {
    constructor(public readonly returnValues: any,
...
export class EventReader {
    ...
    read(contractAddress: string,
         contractAbi: any,
         eventName: string,
         handler: EventHandler,
         fromBlock?: number,
         toBlock?: number): Promise<EventHandlingResult[]> {
        return new Promise((resolve, reject) => {
            if (this._web3 === undefined) {
                ...
                contract.getPastEvents('allEvents', {
                    ...
                    let handlingPromises: Promise<EventHandlingResult>[] = [];
